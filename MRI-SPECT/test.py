...
def hyper_parametrs():
    ...
    parse.add_argument('--spect_file',type=str,default=r'', \
                       help='the test spect dataset path')
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for i in range(len(mri)):
            ...
            cv2.imwrite('./MRI-SPECT/results'+'/'+str(i+1)+'.jpg',result)
